...
class AccountController < ApplicationController
  ...
  attr_reader :forms_auth
  
  def initialize(forms_auth_svc=nil, user_svc=nil)
    super(user_svc)
  ...
  def sign_on
	...
	forms_auth.sign_in username, params[:remember_me]
  ...
  def register
    ...
    if request.post?
      ...
      if validate_matching_passwords(params[:"user.password"], params[:confirm_password]) and @user.is_valid
        ...
        forms_auth.sign_in @user.username, false
