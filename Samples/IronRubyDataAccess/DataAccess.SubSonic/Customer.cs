...
namespace DataAccess.SubSonic
{
	...
	public partial class Customer : ActiveRecord<Customer>
	{
		...
		/// </summary>
		public static void Insert(int varId,string varCustomerID,string varCompanyName,string varContactName,string varContactTitle,string varAddress,string varCity,string varRegion,string varPostalCode,string varCountry,string varPhone,string varFax)
		{
		...
		/// </summary>
		public static void Update(int varId,string varCustomerID,string varCompanyName,string varContactName,string varContactTitle,string varAddress,string varCity,string varRegion,string varPostalCode,string varCountry,string varPhone,string varFax)
		{
			Customer item = new Customer();
